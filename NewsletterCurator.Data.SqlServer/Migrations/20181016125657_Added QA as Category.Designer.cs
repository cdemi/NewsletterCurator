...
namespace NewsletterCurator.Data.Migrations
{
    ...
    [Migration("20181016125657_Added QA as Category")]
    partial class AddedQAasCategory
    {
            ...
            modelBuilder.Entity("NewsletterCurator.Data.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { ID = new Guid("b3e0baf7-3b80-4866-b9ae-3a2e77ad88fb"), Name = "Hardware", Priority = 5.5f },
                        new { ID = new Guid("a1e0baf7-3b80-4866-b9ae-3a2e77ad88fb"), Name = "Quality Assurance", Priority = 5.8f },
                        new { ID = new Guid("84754987-6f3f-4b5e-a79d-a61b13a61647"), Name = "eSports", Priority = 8.5f },
