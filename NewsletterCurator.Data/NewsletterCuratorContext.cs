        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>(options =>
            {
                options.HasData(
                    ...
                    new Category { ID = new Guid("67e0baf7-3b80-4866-b9ae-3a2e77ad88fb"), Color = "#388f5b", HashTags = new string[] { "Robotics" }, Name = "Robotics", Priority = 6.9f },
                    new Category { ID = new Guid("57e0baf7-3b80-4866-b9ae-3a2e77ad88fb"), Color = "#2196f3", HashTags = new string[] { "AI", "ArtificialIntelligence" }, Name = "Artificial Intelligence", Priority = 7 },
                    ...
                    new Category { ID = new Guid("23e0baf7-3b82-4866-b8ae-5a2e77ad88fb"), Color = "#b53f44", HashTags = new string[] { "Agile", "Scrum" }, Name = "Agile", Priority = 5.84f },
                    ...
                    new Category { ID = new Guid("847BF497-33A2-424C-A1DB-5A722D94078A"), Color = "#88b224", HashTags = new string[] { "OpenSource", "OSS", "FOSS" }, Name = "Open Source", Priority = 5.7f },
